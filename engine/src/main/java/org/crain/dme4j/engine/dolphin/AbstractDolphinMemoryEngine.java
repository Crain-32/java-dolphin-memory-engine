...
import org.crain.dme4j.engine.AbstractWritingMemoryEngine;
...
abstract class AbstractDolphinMemoryEngine extends AbstractWritingMemoryEngine {
    ...
    static volatile Charset DEFAULT_CHARSET;

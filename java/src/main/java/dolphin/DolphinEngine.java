...
import jna.NotWindowsAccessor;
import jna.WindowsAccessor;
...
public class DolphinEngine {
    ...
    private DolphinAccessor dolphinAccessorFactory() {
        if (SystemUtils.IS_OS_WINDOWS) {
            ...
            return Native.load(LibNameUtil.getTargetLib(), WindowsAccessor.class, options);
        }
        return Native.load(LibNameUtil.getTargetLib(), NotWindowsAccessor.class);
    }
    ...
    // We don't want to expose this in the main release
//    public DolphinAccessor getDolphinAccessor() {
//        return this.dolphinAccessor;
//    }
